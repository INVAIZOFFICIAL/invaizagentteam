...
// import { registerContentGenerateJob } from '@/cron/jobs/contentGenerate.js'; // 노션 AI로 대체 — 비활성화
...
import { registerCsCollectJob } from '@/cron/jobs/csCollect.js';
...
async function main(): Promise<void> {
  ...
  // registerContentGenerateJob(); // 노션 AI로 대체 — 비활성화
